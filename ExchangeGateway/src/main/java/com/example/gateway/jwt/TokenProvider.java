...
import com.example.gateway.exception.DataException;
import com.example.gateway.properties.JwtConfigProperties;
...
public class TokenProvider implements InitializingBean {
    ...
    public boolean validateJwtToken(String authToken) throws JwtException {
        try {
            ...
            throw new DataException(401, "INVALID JWT SIGNATURE.");
        } catch (ExpiredJwtException e) {
            log.error("EXPIRED JWT TOKEN.");
            throw new DataException(401, "EXPIRED JWT TOKEN.");
        } catch (UnsupportedJwtException e) {
            log.error("UNSUPPORTED JWT TOKEN.");
            throw new DataException(401, "UNSUPPORTED JWT TOKEN.");
        } catch (IllegalArgumentException e) {
            log.error("JWT TOKEN IS INVALID.");
            throw new DataException(401, "JWT TOKEN IS INVALID.");
        }
    }
